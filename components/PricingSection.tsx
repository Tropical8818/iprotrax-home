...
export function PricingSection() {
    ...
    const plans: PricingPlan[] = [
        ...
        },
        {
            ...
            description: t("Cloud-hosted solution for agile teams getting started.", "云托管方案，适合敏捷团队快速启动。"),
            features: [
                t("Zero Deployment (Cloud Hosted)", "无需部署 (云托管)"),
                t("Standard Dashboard", "标准管理看板"),
                t("Real-time Kiosk Mode", "实时看板模式"),
                t("5 Users Included", "5 个账号包含"),
                t("Basic Analytics", "基础数据分析"),
            ],
        ...
        },
        {
            ...
            features: [
                ...
                t("Full Data Sovereignty", "完全数据主权"),
                t("Unlimited Users", "及无限用户"),
                t("AI Copilot Integration", "AI Copilot 集成"),
